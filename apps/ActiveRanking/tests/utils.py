...
experiment_url = 'http://ec2-35-167-172-196.us-west-2.compute.amazonaws.com:8000/api/experiment/1faeb7fc70a06e821826af9635a153/logs'
...
#for l in events:
#    if l['alg']=='QS':
#        f.write(','.join(str(x) for x in [l['left_id'], l['right_id'], l['winner_id'], l['id'], l['function'], l['timestamp'], l['waitingforresponse'], l['queryqueuesallqs'], l['stackparametersallqs'], l['msg']]) + '\n\n')
#f.close()
#
